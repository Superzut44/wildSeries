 ...
 */
final class Version20211206230133 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program ADD category_id INT NOT NULL, ADD title VARCHAR(255) NOT NULL, ADD summary VARCHAR(255) NOT NULL, ADD poster VARCHAR(255) NOT NULL');
