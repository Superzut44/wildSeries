 ...
 */
final class Version20211206183228 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE season DROP program_id, DROP number, DROP year');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE season ADD program_id INT NOT NULL, ADD number INT NOT NULL, ADD year INT NOT NULL');
